...
interface AsiaSelOrderDetailsInfoModalPlansProps {
  modalOpen: boolean;
  packDetails: any;
  setModalOpen: Function;
}

const AsiaSelOrderDetailsInfoModalForPlans: React.FC<
AsiaSelOrderDetailsInfoModalPlansProps
> = ({ modalOpen, setModalOpen, packDetails }) => {
  // Debug log when component renders or packDetails changes
  useEffect(() => {
    console.log('Asia Sel Modal - packDetails:', {
              ...
              <div className="bg-gradient-to-br from-[#190237] to-[#2a0f4f] rounded-xl p-5 text-white shadow-lg">
                <div className="space-y-4">
                  <div className="flex justify-between items-center pb-3 border-b border-white/10">
                    ...
                    <span className="font-bold text-lg">ASIA Cell</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-orange font-semibold text-sm">{t('bankDetails.accountNumber')}</span>
                    <span className="font-bold text-lg tracking-wider">7702930873</span>
                  </div>
                </div>
              </div>
            </div>
...
export default AsiaSelOrderDetailsInfoModalForPlans;
