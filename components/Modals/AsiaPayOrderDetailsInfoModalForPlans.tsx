...
interface AsiaPayOrderDetailsInfoModalPlansProps {
  modalOpen: boolean;
  packDetails: any;
  setModalOpen: Function;
}

const AsiaPayOrderDetailsInfoModalForPlans: React.FC<
AsiaPayOrderDetailsInfoModalPlansProps
> = ({ modalOpen, setModalOpen, packDetails }) => {
  // Debug log when component renders or packDetails changes
  useEffect(() => {
    console.log('Asia Pay Modal - packDetails:', {
              ...
              <div className="bg-gradient-to-br from-[#190237] to-[#2a0f4f] rounded-xl p-5 text-white shadow-lg">
                <div className="space-y-4">
                  <div className="flex justify-between items-center pb-3 border-b border-white/10">
                    ...
                    <span className="font-bold text-lg">ASIA PAY</span>
                  </div>
...
export default AsiaPayOrderDetailsInfoModalForPlans;
